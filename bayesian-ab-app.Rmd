...
```{r}
renderValueBox({
  valueBox(paste0(round(global_vars$control*100,2),"%"), icon = "fa-font", color = "#00747F")
...
```{r}
renderValueBox({
  valueBox(paste0(round(global_vars$test*100,2),"%"), icon = "fa-bold", color = "#00747F")
...
renderValueBox({
  valueBox(paste0(round(global_vars$difference*100,2),"%"), icon = "fa-balance-scale",
           color = if_else(global_vars$difference < 0, "#FF6D00", "#00A2B1"))
...
renderValueBox({
  valueBox(global_vars$srm$ratio, icon = "fa-adjust",
           color = if_else(global_vars$srm$test == TRUE, "#FF6D00", "#00A2B1"))
