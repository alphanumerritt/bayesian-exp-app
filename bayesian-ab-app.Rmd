...
library(shiny)
library(bayestestR) # Currently just for confidence intervals...lazy
...
Row {data-height=30}
-------------------------------------
**version 2.2** - To see version history, report bugs and submit feature requests [click here](https://github.com/alphanumerritt/bayesian-exp-app/issues){target="_blank"}.
