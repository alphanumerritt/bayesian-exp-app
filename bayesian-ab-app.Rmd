...
### How it works
We must accept that there may be many different approaches to A/B testing under the banner of Bayesian frameworks. Hence, your mileage on these generalizations may vary. This app
1. Define priors
2. Assemble test data
3. Define a model
3. Simulate posteriors
4. Analyze posteriors
- Use of Priors [illustrates how priors are combined with observed data](https://www.countbayesie.com/blog/2015/4/25/bayesian-ab-testing){target="_blank"}
- Credible intervals
